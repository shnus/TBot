...
public class VoteCommandsVerification {
    ...
    public static VerificationsStatus verifyCreateVoteCommand(
    ...
    public static VerificationsStatus verifyVoteCommand(
            Map<String, String> chatToken,
            Map<String, String> chatUser,
            String curChatId, String curUserId
    ) {
    ...
    public static VerificationsStatus verifyEndVoteCommand(
            Map<String, String> chatToken,
            Map<String, String> chatUser,
            String curChatId, String curUserId
    ) {
    ...
    public static VerificationsStatus verifyResultsCommand(
            Map<String, String> chatToken,
            Map<String, String> chatUser,
            String curChatId, String curUserId
    ) {
